...
$breevia_theme_divider_style = array(
...
$breevia_title                         =  'Breathe In, Explore More';
$breevia_subtitle                      =  "Bringing your imaginative ideas to life with boundless imagination and innovative thinking is a remarkable journey that thrives on the synergy of innovation.";
$breevia_theme_action_button           =  'Get in control';
$breevia_theme_action_button_secondary =  'Contact us';

$defaults = array(
	'default_icon'                      => $breevia_theme_svg_icons['fort-awesome'],
	'icons'                             => $breevia_theme_svg_icons,
	'divider_style'                     => $breevia_theme_divider_style,
	'gradients'                         => $breevia_gradients,

	'assets_js_key'                     => 'kubioFrontendData',

	'edit_this_text_in_customizer'      => $breevia_title,
	'lorem_ipsum'                       => $breevia_subtitle,
	...
	'front-header'                      => array(
		...
		'buttons'      => array(
			...
			'value' => array(
				array(
					'label'       => sprintf( $breevia_theme_action_button, 1 ),
					'url'         => '#',
					'button_type' => '0',
					'index'       => 0,
				),
				array(
					'label'       => sprintf( $breevia_theme_action_button_secondary, 1 ),
					'url'         => '#',
					'button_type' => '1',
					'index'       => 1,
				),
		...
		'subtitle'     => array(
			'show'  => true,
			'value'      => $breevia_subtitle,
			'localProps' => array(
				'content' => $breevia_subtitle
			),
			'style' => array(
				'descendants' => array(
					'text' => array(
						...
						'background' => array(
							...
							'overlay'   =>
								array(
									...
									'gradient'         => $breevia_gradients['default'],
							...
							'image'     => array(
								array(
									'source'     => array(
										'url'      =>  get_template_directory_uri() . '/resources/images/beach-landscape-sea-water-nature-sand-1061655-pxhere.com.jpg',
										'gradient' => $breevia_gradients['night_fade'],
									),
		...
		'social_icons' => array(
			...
			'localProps' => array(
				'iconList' => array(
					array(
						'icon'       => $breevia_theme_svg_icons['facebook-square-full'],
						'link_value' => '#',
						'index'      => 0,
					),
					array(
						'icon'       => $breevia_theme_svg_icons['twitter-x'],
						'link_value' => '#',
						'index'      => 1,
					),
					array(
						'icon'       => $breevia_theme_svg_icons['youtube'],
						'link_value' => '#',
						'index'      => 2,
					),
					array(
						'icon'       => $breevia_theme_svg_icons['vimeo'],
						'link_value' => '#',
						'index'      => 3,
					),
				),
		...
		'icon_list'    => array(
			...
			'localProps' => array(
				'iconList' => array(
					array(
						'icon'       => $breevia_theme_svg_icons['map-marker'],
						'text'       => '123, Main Street, City, Country',
						'link_value' => 'https://maps.google.com/',
						'index'      => 0,
					),
					array(
						'icon'       => $breevia_theme_svg_icons['phone'],
						'text'       => '+1 234 567 890',
						'link_value' => 'tel:+1 234 567 890',
						'index'      => 0,
					),
					array(
						'icon'       => $breevia_theme_svg_icons['envelope'],
	...
	'header'                            => array(
		...
		'social_icons' => array(
			...
			'localProps' => array(
				'icons' => array(
					...
					array(
						'icon'       => $breevia_theme_svg_icons['whatsapp-square'],
						'link_value' => '#',
						'index'      => 1,
					),
					array(
		...
		'icon_list'    => array(
			...
			'localProps' => array(
				'iconList' => array(
					array(
						'icon'       => $breevia_theme_svg_icons['map-pin'],
						'text'       => '1557 Frosty Lane, Binghamton, NY',
						'link_value' => '#',
						'index'      => 0,
					),
					array(
						'icon'       => $breevia_theme_svg_icons['phone-square'],
