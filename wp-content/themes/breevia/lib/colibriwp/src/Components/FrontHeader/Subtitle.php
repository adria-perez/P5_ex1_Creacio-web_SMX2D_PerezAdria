		...
		return array(
			...
			'settings' => array(
				...
				"{$prefix}localProps.content" => array(
					'default' => __( 'Bringing your imaginative ideas to life with boundless imagination and innovative thinking is a remarkable journey that thrives on the synergy of innovation.', 'breevia' ),
					'control' => array(
